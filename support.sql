...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 19-Maio-2020 às 15:37
...
(1, '01', 'criar tabela clientes', 'SQL', 'V01__criar_tabela_clientes.sql', -895245380, 'root', '2019-07-14 14:58:50', 304, 1),
(2, '02', 'cria tabela pais estado cidades', 'SQL', 'V02__cria_tabela_pais_estado_cidades.sql', -216400304, 'root', '2019-07-14 14:58:53', 2200, 1),
(3, '03', 'cria tabela contato', 'SQL', 'V03__cria_tabela_contato.sql', 1001618047, 'root', '2019-07-14 14:58:53', 272, 1),
(4, '04', 'criar tabela usuario grupo permissao', 'SQL', 'V04__criar_tabela_usuario_grupo_permissao.sql', 1548458265, 'root', '2020-02-22 17:01:47', 2491, 1);
...
CREATE TABLE IF NOT EXISTS `tbl_cidade` (
  ...
  `estado_codigo` int(5) DEFAULT NULL,
  PRIMARY KEY (`codigo_cidade`),
  KEY `estado_codigo` (`estado_codigo`)
...
INSERT INTO `tbl_cidade` (`codigo_cidade`, `nome`, `estado_codigo`) VALUES
(1, 'Afonso Cláudio', 8),
...
CREATE TABLE IF NOT EXISTS `tbl_cliente` (
  ...
  `rg_razao_social` varchar(100) DEFAULT NULL,
  `situacao` varchar(50) DEFAULT NULL,
  `tipo_pessoa` varchar(15) NOT NULL,
  `cpf_cnpj` varchar(30) NOT NULL,
  `ins_estadual` varchar(25) DEFAULT NULL,
...
INSERT INTO `tbl_cliente` (`id`, `nome_fantasia`, `rg_razao_social`, `situacao`, `tipo_pessoa`, `cpf_cnpj`, `ins_estadual`, `email`, `telefone`, `celular`, `logradouro`, `descricao`, `bairro`, `complemento`, `cidade`, `estado`, `cep`, `observacoes`) VALUES
(1, 'Cielo S.A', 'Cielo Representações financeiras', 'ATIVO', 'JURIDICA', '58.409.555/0001-71', 'Isento', 'cielo@cielo.com.br', '(11)5362-6897', '(11)46586-3232', 'Avenida', 'Paulista, 1001', 'Jardinópolis', '', NULL, NULL, '38747-040', NULL),
(2, 'Diego Marcolino Santana', '14710933-SSPMG', 'INATIVO', 'FISICA', '075.220.626-59', 'Isento', 'diegomsantana@gmail.com', '(34)3831-5555', '(34)99169-8652', 'Rua', 'Expedito Dias, 1567', 'São Benedito', '', NULL, NULL, '38747-040', NULL),
(3, 'Sequoia Capital', 'Sequoia Capital S.A', 'ATIVO', 'JURIDICA', '02.174.960/0001-01', 'Isento', 'sequoia.cap@capital.com', '(11)1111-1111', '(22)22222-2222', 'Avenida', 'Paulista, 1001', 'Centro', '', NULL, NULL, '38.747-040', NULL),
(4, 'Banco Berkeley  Investimentos', 'Berkeley Hathaway S.A', 'ATIVO', 'JURIDICA', '52.768.857/0001-50', 'Isento', 'diegomsantana@gmail.com', '(11)5555-5555', '(55)11111-1111', 'Avenida', '', '', '', NULL, NULL, '', NULL),
(5, 'Banco Itaú', 'Itaú Unibanco S.A', 'ATIVO', 'JURIDICA', '95.128.908/0001-91', 'Isento', 'amanda.cristina.ptc@hotmail.com', '(11)6666-6666', '(44)22222-2222', 'Avenida', '', '', '', NULL, NULL, '', NULL),
(6, 'Banco Hathaway', 'Hathaway Representações Financeiras', 'ATIVO', 'JURIDICA', '34.515.975/0001-74', 'Isento', 'diegomsantana@gmail.com', '(56)3333-3333', '(88)22222-2222', 'Avenida', '', '', '', NULL, NULL, '', NULL),
(8, 'Banco Paradise', 'Paradise Financeira S.A', 'ATIVO', 'JURIDICA', '37.508.278/0001-84', 'Isento', 'diegomsantana@gmail.com', '(11)4444-4444', '(88)55555-5555', 'Avenida', '', '', '', NULL, NULL, '', NULL),
(9, 'Banco Bradesco ', 'Bradesco S.A', 'ATIVO', 'JURIDICA', '26.712.252/0001-37', 'Isento', 'amanda.cristina.ptc@hotmail.com', '(11)4545-6468', '(11)54876-4646', 'Avenida', '', '', '', NULL, NULL, '', NULL),
(10, 'Citybank  Internacional', 'Citybank Representações Financeiras S.A', 'ATIVO', 'JURIDICA', '97.816.462/0001-13', 'Isento', 'diegosantana@gmail.com', '(11)4585-7956', '(11)46876-5465', 'Avenida', 'Expedito Dias, 1567', 'Centro', '', NULL, NULL, '38747-040', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book'),
(11, 'TNT Videolocadora', 'Marcolino e Santana LTDA', 'ATIVO', 'JURIDICA', '15.366.324/0001-15', 'Isento', 'diegomsantana@gmail.com.br', '(34)5568-9798', '(34)16546-4798', 'Avenida', '', '', '', NULL, NULL, '', 'Loja de Motos especializado em venda de semi-novos.');
...
CREATE TABLE IF NOT EXISTS `tbl_contato` (
  `codigo_contato` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_estado` (
  ...
  `pais_codigo` int(7) DEFAULT NULL,
...
INSERT INTO `tbl_estado` (`codigo_estado`, `nome`, `uf`, `pais_codigo`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
INSERT INTO `tbl_eventos` (`id`, `title`, `color`, `start`, `end`, `observacoes`) VALUES
(5, 'Verificar parcelas casa', '#228B22', '2020-05-11 14:00:00', '2020-05-11 15:00:00', 'Verificar com advogado se o resumo foi enviado pelo banco e alinhar as próximas medidas.'),
(4, 'Verificar acesso ao drive algaworks', '#FF4500', '2020-05-05 08:00:00', '2020-05-05 20:00:00', 'Foi verificado no dia e o acesso estava bloqueado.'),
(6, 'Teste', '#FFD700', '2020-05-08 08:00:00', '2020-05-08 18:00:00', ''),
(7, 'Subir novos projetos para o github', '#1C1C1C', '2020-05-18 10:00:00', '2020-05-18 12:00:00', 'Criar os novos repositórios no Github e subir os códigos.');
...
INSERT INTO `tbl_grupo` (`codigo`, `nome`) VALUES
(1, 'Administrador'),
(2, 'Funcionario');
...
--
-- Estrutura da tabela `tbl_grupo_permissao`
--
...
--
-- Extraindo dados da tabela `tbl_grupo_permissao`
--

INSERT INTO `tbl_grupo_permissao` (`codigo_grupo`, `codigo_permissao`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4),
...
--
-- Estrutura da tabela `tbl_item_produto`
--

DROP TABLE IF EXISTS `tbl_item_produto`;
CREATE TABLE IF NOT EXISTS `tbl_item_produto` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  KEY `codigo_ordem_servico` (`codigo_ordem_servico`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tbl_item_produto`
--

INSERT INTO `tbl_item_produto` (`id`, `quantidade`, `valor_unitario`, `codigo_produto`, `codigo_ordem_servico`) VALUES
(4, 1, '2754.05', 11, 6),
(5, 3, '599.00', 9, 7),
(6, 1, '2754.05', 11, 9);
...
CREATE TABLE IF NOT EXISTS `tbl_ordem_servico` (
  ...
  `canal_venda` varchar(30) DEFAULT NULL,
  ...
  `condicoes` varchar(200) DEFAULT NULL,
  `defeitos` varchar(150) DEFAULT NULL,
  `acessorios` varchar(150) DEFAULT NULL,
  `solucao` varchar(300) DEFAULT NULL,
  `laudoTecnico` varchar(400) DEFAULT NULL,
  `termoGarantia` varchar(200) DEFAULT NULL,
...
INSERT INTO `tbl_ordem_servico` (`id`, `situacao`, `data_criacao`, `previsao_entrega`, `canal_venda`, `total`, `observacoes`, `descricao`, `marca`, `modelo`, `serie`, `condicoes`, `defeitos`, `acessorios`, `solucao`, `laudoTecnico`, `termoGarantia`, `codigo_cliente`, `codigo_usuario`) VALUES
(1, 'Fechado', '2020-04-10', '2020-04-10', 'REMOTO', '22.50', 'SDFGDFG', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1),
(6, 'ABERTO', NULL, NULL, 'Presencial', '3087.38', '', '', '', '', '', '', '', '', '', '', '', 4, 1),
(7, 'ABERTO', NULL, NULL, 'Presencial', '1987.00', '', 'Impressora HP 3310', 'HP', 'Laserjet3060', '8754385745ME', 'Equipamento está com a carcaça quebrada na parte superior esquerda.', 'Não imprime colorido.', 'cabo de alimentação e cabo usb.', '', '', '', 8, 1),
(8, 'ABERTO', '2020-04-14', NULL, 'Presencial', '0.00', '', '', '', '', '', '', '', '', '', '', '', 8, 1),
(9, 'ABERTO', '2020-04-14', '2020-04-25', 'Presencial', '2849.05', '', 'Impressora HP 3310', 'HP', 'Laserjet3060', '8754385745ME', '', '', '', '', '', '', 9, 1),
(10, 'FECHADO', '2020-04-15', '2020-04-25', 'Remoto', '75.00', '', 'Notebook lenovo', 'Lenovo', 'Lenovo', '11133222', 'Notebook em perfeito estado de conservação externamente.', 'Cliente solicitou formatação.', 'cabo de alimentação de energia.', 'Formatação com windows 10.', '', '', 2, 1);
...
--
-- Extraindo dados da tabela `tbl_pais`
--

INSERT INTO `tbl_pais` (`codigo_pais`, `nome`, `sigla`) VALUES
(1, 'Brasil', 'BR');
...
INSERT INTO `tbl_permissao` (`codigo`, `nome`) VALUES
(1, 'ROLE_CADASTRAR_CIDADE'),
(2, 'ROLE_CADASTRAR_USUARIO'),
(3, 'ROLE_CADASTRAR_ORDEM_SERVICO'),
(4, 'ROLE_CADASTRAR_PRODUTO'),
(5, 'ROLE_CADASTRAR_FORNECEDOR');
...
INSERT INTO `tbl_produto` (`id`, `nome_produto`, `codigo_interno`, `codigo_barras`, `grupo_produto`, `preco_unitario`, `detalhes`, `foto`, `content_type`) VALUES
(1, 'Impressora HP Deskjet 2230', 'SXGLC003373303', NULL, 'Informatica', '299.90', NULL, NULL, NULL),
(2, 'Impressora Multifuncional Epson L5190', 'WXPCZ652233410', NULL, 'Informatica', '1329.05', NULL, NULL, NULL),
(3, 'Notebook Lenovo Ideapad S145', 'LPTLV472317602', NULL, 'Informatica', '3229.05', NULL, NULL, NULL),
(8, 'Impressora Multifuncional HP Smart Tank 617', 'PLJGL056745614', NULL, 'Informatica', '1329.09', NULL, '', 'image/png'),
(9, 'Impressora Multifuncional HP CH350C', 'VMTWC416572367', NULL, 'Informatica', '599.00', NULL, 'c1b60840-dc1c-45c3-96ed-670295253c45_índice.jpg', 'image/jpeg'),
(10, 'Conector RJ45 fêmea Furukawa', 'ESTSM617065665', NULL, 'Informatica', '5.50', NULL, '9e5d69b2-7a13-41d9-a873-3b5b1984ab82_images.jpg', 'image/jpeg'),
(11, 'Notebook Lenovo Ideapad 330 15 Polegadas', 'ABBQL411532737', NULL, 'Informatica', '2754.05', ' O notebook Lenovo S145-15IWL Ideapad S145 é compacto e sofisticado. A tela HD de 15.6\" é antirreflexo e as bordas ultrafinas do notebook permitem uma tela infinita, para você ter um notebook com design muito mais elegante. O modelo vem equipado com placa de Vídeo integrada Intel UHD Graphics 620, que resulta em mais agilidade e performance para a edição de fotos e vídeos. Desempenho de ponta com processador Intel Core i5-8265U; memória RAM de 8GB; capacidade do HD de 1TB, além do sistema operacional Windows 10 home assegura um notebook de alta tecnologia. Alto falantes com certificação Dolby Áudio garantem som alto e definido. Conte com o WiFi AC ultrarrápido para mais velocidade de navegação, e também com conexões como 02 USB 3.1, 01 USB 2.0, 01 Porta combo para Headset/Smartphone e 01 HDMI. ', '2ba749ff-6bad-4721-a2ff-f66d2e63b23f_notebook_lenovo.jpg', 'image/jpeg');
...
INSERT INTO `tbl_servico` (`id`, `descricao`, `detalhes`, `quantidade`, `valor_unitario`, `codigo_ordem_servico`) VALUES
(1, 'Conserto Impressora', 'Teste', 1, '333.33', 6),
(2, 'Conserto Impressora', 'Teste', 2, '95.00', 7),
(3, 'Conserto Impressora', 'Conserto cabeça de impressão', 1, '95.00', 9),
(4, 'Formatação', 'Formatação com backup', 1, '75.00', 10);
...
INSERT INTO `tbl_usuario` (`codigo`, `nome`, `email`, `senha`, `ativo`, `data_nascimento`) VALUES
(1, 'Diego Marcolino Santana', 'admin@diego.com', '$2a$10$BP3qGCpa1D4Zrc8eMV14XuCH6KqRYq3aOmQpkGH4wO8NxFGDR8BqS', 1, NULL),
(2, 'Amanda Cristina Lourenço', 'amanda@diego.com', '$2a$10$BP3qGCpa1D4Zrc8eMV14XuCH6KqRYq3aOmQpkGH4wO8NxFGDR8BqS', 1, NULL);
...
INSERT INTO `tbl_usuario_grupo` (`codigo_usuario`, `codigo_grupo`) VALUES
(1, 1),
(2, 2);
...
ALTER TABLE `tbl_cidade`
  ADD CONSTRAINT `tbl_cidade_ibfk_1` FOREIGN KEY (`estado_codigo`) REFERENCES `tbl_estado` (`codigo_estado`);

--
-- Limitadores para a tabela `tbl_estado`
--
ALTER TABLE `tbl_estado`
  ADD CONSTRAINT `tbl_estado_ibfk_1` FOREIGN KEY (`pais_codigo`) REFERENCES `tbl_pais` (`codigo_pais`);

--
-- Limitadores para a tabela `tbl_grupo_permissao`
--
ALTER TABLE `tbl_grupo_permissao`
  ADD CONSTRAINT `tbl_grupo_permissao_ibfk_1` FOREIGN KEY (`codigo_grupo`) REFERENCES `tbl_grupo` (`codigo`),
  ADD CONSTRAINT `tbl_grupo_permissao_ibfk_2` FOREIGN KEY (`codigo_permissao`) REFERENCES `tbl_permissao` (`codigo`);

--
-- Limitadores para a tabela `tbl_item_produto`
--
ALTER TABLE `tbl_item_produto`
  ADD CONSTRAINT `tbl_item_produto_ibfk_1` FOREIGN KEY (`codigo_produto`) REFERENCES `tbl_produto` (`id`),
  ADD CONSTRAINT `tbl_item_produto_ibfk_2` FOREIGN KEY (`codigo_ordem_servico`) REFERENCES `tbl_ordem_servico` (`id`);

--
-- Limitadores para a tabela `tbl_ordem_servico`
--
ALTER TABLE `tbl_ordem_servico`
  ADD CONSTRAINT `tbl_ordem_servico_ibfk_1` FOREIGN KEY (`codigo_cliente`) REFERENCES `tbl_cliente` (`id`),
  ADD CONSTRAINT `tbl_ordem_servico_ibfk_2` FOREIGN KEY (`codigo_usuario`) REFERENCES `tbl_usuario` (`codigo`);

--
-- Limitadores para a tabela `tbl_servico`
--
ALTER TABLE `tbl_servico`
  ADD CONSTRAINT `tbl_servico_ibfk_1` FOREIGN KEY (`codigo_ordem_servico`) REFERENCES `tbl_ordem_servico` (`id`);

--
-- Limitadores para a tabela `tbl_usuario_grupo`
--
ALTER TABLE `tbl_usuario_grupo`
  ADD CONSTRAINT `tbl_usuario_grupo_ibfk_1` FOREIGN KEY (`codigo_usuario`) REFERENCES `tbl_usuario` (`codigo`),
  ADD CONSTRAINT `tbl_usuario_grupo_ibfk_2` FOREIGN KEY (`codigo_grupo`) REFERENCES `tbl_grupo` (`codigo`);
COMMIT;
