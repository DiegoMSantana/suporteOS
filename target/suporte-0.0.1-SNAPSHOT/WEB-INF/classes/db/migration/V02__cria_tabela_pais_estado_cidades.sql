...
INSERT INTO tbl_pais (codigo_pais, nome, sigla) VALUES (1, 'Brasil', 'BR');
...
CREATE TABLE IF NOT EXISTS tbl_estado (
  ...
  FOREIGN KEY (pais_codigo) REFERENCES  tbl_pais(codigo_pais)
...
CREATE TABLE IF NOT EXISTS tbl_cidade (
  ...
  FOREIGN KEY (estado_codigo) REFERENCES tbl_estado(codigo_estado)
